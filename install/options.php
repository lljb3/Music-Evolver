<?php
	...
	function tt_custom_login() {
		...
		$output  = '<style type="text/css">';
			...
			$login_logo = $evolver_theme_option['logo-login']['url'];
			$background_login = $evolver_theme_option['background-login'];
			if ( !empty( $login_logo ) ) {
	...
	function tt_custom_styles() {
		global $evolver_theme_option;
		$opacity = $evolver_theme_option['opacity-slider'];
		// Content Buttons
		$btn_bg = $evolver_theme_option['color-content-link'];
		$btn_bg_hover = $evolver_theme_option['color-content-link'];
		$btn_text = $evolver_theme_option['color-content-link'];
		$btn_text_hover = $evolver_theme_option['color-button-text'];
		// Read More Buttons
		$read_more_bg = $evolver_theme_option['color-blog-posts-read-more-bg'];
		$read_more_bg_hover = $evolver_theme_option['color-blog-posts-read-more-bg-hover'];
		$read_more_text = $evolver_theme_option['color-blog-posts-read-more-text'];
		$read_more_text_hover = $evolver_theme_option['color-blog-posts-read-more-text-hover'];
		// Custom Styles
		$custom_styles = $evolver_theme_option['custom-styles'];
